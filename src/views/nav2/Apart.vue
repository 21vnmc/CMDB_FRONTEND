<template>
    <section>
        ...
        <el-table :data="pageApartment" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
            ...
            <el-table-column type="index" width="280">
            </el-table-column>
            <el-table-column prop="name" label="数据中心-房间名称" width="280" sortable>
                <template slot-scope="scope">
                    <router-link :to="{ name: 'apartment_info', query: { a_id: scope.row.id } }" target="_self">
                        {{scope.row.data_center_name}}-{{scope.row.apartment_name}}
                    </router-link>
                </template>
            </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            handleAdd: function () {
                ...
                console.log(this.getAreaList, 123)
            },
